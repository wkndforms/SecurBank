...
## Environments
- Preview: https://main--SecurBank--wkndforms.hlx.page/
- Live: https://main--SecurBank--wkndforms.hlx.live/
...
1. Open the `SecurBank` directory in your favorite IDE and start coding :)
